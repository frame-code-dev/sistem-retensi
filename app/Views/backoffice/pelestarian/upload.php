    ...
    <div class="p-4 mt-14">
        ...
        <div class="card bg-white p-5 mt-4 border rounded-md w-full relative">
            ...
            <div class="mt-5">
                    ...
                    <div class="grid grid-cols-2 gap-4 py-4">
                            ...
                            <ul class="w-full space-y-1 text-gray-500 list-inside dark:text-gray-400 border p-3">
                                <li class="flex items-center">
                                    <div class="flex items-center mb-4">
                                        <input id="ringkasan_masuk_dan_keluar" checked name="ringkasan_masuk_dan_keluar" data-id="Ringkasan Masuk Dan Keluar" type="checkbox" value="ringkasan_masuk_value" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                ...
                                <li class="flex items-center">
                                    <div class="flex items-center mb-4">
                                        <input id="resume_medis" checked name="resume_medis" data-id="Resume medis" type="checkbox" value="resume_medis_value" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                ...
                                <li class="flex items-center">
                                    <div class="flex items-center mb-4">
                                        <input id="lembar_operasi" checked name="lembar_operasi" data-id="Lembar operasi (termasuk laporan persalinan)" type="checkbox" value="lembar_operasi_value" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div>
                            <ul class="w-full space-y-1 text-gray-500 list-inside dark:text-gray-400 border p-3">
                                <li class="flex items-center">
                                    <div class="flex items-center mb-4">
                                        <input id="identifikasi_bayi" checked name="identifikasi_bayi" data-id="Identifikasi bayi lahir" type="checkbox" value="identifikasi_bayi_lahir_value" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                ...
                                <li class="flex items-center">
                                    <div class="flex items-center mb-4">
                                        <input id="lember_persetujuan" checked name="lember_persetujuan" data-id="Lembar persetujuan tindakan medis (informed consent)" type="checkbox" value="lembar_persetujuan_value" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <form action="<?= base_url('dashboard/pelestarian/upload/store/'.$data['id']) ?>" method="POST" class="w-full mx-auto space-y-4" enctype="multipart/form-data">
