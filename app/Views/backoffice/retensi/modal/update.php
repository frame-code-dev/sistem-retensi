        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4">
                <div class="w-full mx-auto" >
                    <form action="<?=base_url('dashboard/list-retensi/update')?>" method="POST" class="w-full mx-auto" >
                    <input type="text" name="id" id="id" class="id" hidden>
                    <h4 class="font-bold underline">Apakah anda yakin Pemusnahan Retensi ini?</h4>
                </div>
            </div>
            <!-- Modal footer -->
