            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="flex justify-start content-center align-middle self-end">
                        <div>
                            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Simpan</button>
                        </div>
                        <div>
                            <a href="<?=base_url('excel/Kunjungan Terakhir Pasien.xlsx')?>" download="Import Data.xlsx" type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-md text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
