            ...
            <form action="<?= base_url('dashboard/rekam-medis/store') ?>" method="POST" class="w-full mx-auto space-y-4" enctype="multipart/form-data">
                <div class="grid grid-cols-2 gap-3 ">
                    <div class="">
						...
						<input type="text" placeholder="Masukkan No. Rekam Medis" name="no_rm" maxlength="6" minlength="6"  value="<?= set_value("no_rm") ?>" id="no_rm" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
...
<?=$this->section('js')?>
	<script>
		...
		// NIK
		$('#nik_pasien').on('keyup', function() {
			var noRmValue = $('#nik_pasien').val();
