        ...
        <div class="card bg-white p-5 mt-4 border rounded-md w-full relative">
            ...
            <div class="p-5">
                <div class="flex justify-end p-5 border">
                    <a href="<?=base_url('dashboard/pemusnahan/pdf/'.$id_pdf)?>" download class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                            ...
                            <tr class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white border">
                                ...
                                <td class="font-bold">
                                    <?php if ($row['nama_file'] != null) : ?>
                                        <embed id="pdfPreview" src="<?=base_url('berkas/pemusnahan/'.$data['id'].'/'.$row['nama_file'])?>" type="application/pdf" width="100%" height="500px" />
                                    <?php else : ?>
